...
# Mengatur API key
openai_api_key = "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"  # Ganti dengan API key kamu
...
with gr.Blocks() as demo:
    ...
    msg = gr.Textbox(label="Curhat dong")  # The textbox for user input
